...
struct MacminiM4View: View {
  @State private var viewPoint = ViewPoint.bottom
  ...
  var body: some View {
    ZStack {
      ...
      MacminiM4TopView()
        .rotation3DEffect(.degrees(viewPoint.degrees), axis: (x: 1, y: 0, z: 0), anchorZ: -100)
        .opacity(viewPoint == .top ? 1 : 0)
      MacminiM4SideView()
        .rotation3DEffect(.degrees(90 - viewPoint.degrees), axis: (x: -1, y: 0, z: 0), anchorZ: -100)
